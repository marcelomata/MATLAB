...
global   FigureHndl      ...    % animation figure handle
         ...
         hLeg hCOM hVLeg       ...    % leg, com, virtual leg 
         hTrunk          ...
         hCOMTrace       ...    % COM trace
...
switch flag,
  ...
  case 0,
    ...
    hVLeg  = plot( [0 0], [0 0], 'Color', [0.6 0.6 0.6], 'LineWidth', 1, 'LineStyle', '--');
