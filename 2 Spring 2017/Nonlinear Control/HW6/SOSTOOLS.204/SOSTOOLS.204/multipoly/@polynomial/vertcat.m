...
% SYNTAX 
%   [A; B] 
%      Vertical concatenation of polynomial matrices A
%      and B. A and B must have the same number of columns.
%   [A1; A2; A3; ...]
...
if nargin==1
  ...
  elseif nca == ncb
	...
	idx2 = [idx2 nra+(1:nrb)+i1*(nra+nrb)]; 
      ...
      coef1(:,idx1) = reshape(a.coefficient,nta,nra*nca);
      coef2 = spalloc(ntb,(nra+nrb)*ncb,nnz(b.coefficient));
      coef2(:,idx2) = reshape(b.coefficient,ntb,nrb*ncb);
      coefficient = [coef1; coef2];   
