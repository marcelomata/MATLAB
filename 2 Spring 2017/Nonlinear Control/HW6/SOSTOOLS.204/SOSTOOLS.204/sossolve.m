function [sos,info] = sossolve(sos,alg,tol)
...
%
% Alternatively, SOSP = sossolve(SOSP,ALG,ACC) will specify the accuracy
% ACC and the algorithm used by SeDuMi in solving the semidefinite
% program. If ALG = 0, then a first order algorithm is used. If ALG = 1,
...
% that is generated by SeDuMi or SDPT3.
%
